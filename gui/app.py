...
class AppWindow(QDialog):
    def __init__(self):
        ...
        self.ui.det_img_brw_btn.clicked.connect(self.open_file,self.button_click)
        self.show()
        self.le = QLineEdit()
    ...
    def open_file(self, main_window):
        ...
        if self.file_chosen:
            main_window.det_img_txtbx.setText(self.file_chosen)
            # Change the text on the label to display the file path chosen.
        else:
            main_window.det_img_txtbx.setText("No file was selected. Please select an image.")
